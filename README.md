...
If you want some larger PCAP to run thorough, I have a .zip file with 17G of PCAP [here](https://drive.google.com/file/d/1d6QXF0uk1ZiJKfaqwy4SjfvuyVUGrCte/view?usp=share_link) which is stored in a ~ 3GB zip file. You can download it with gdown and unzip it with tar:
``` 
pip install gdown
